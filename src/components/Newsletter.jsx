...
const Newsletter = () => {
  ...
  const scriptURL =
    'https://script.google.com/macros/s/AKfycbwGXoGLduC5W06KqMtfZRUbB5adhQBuG1GbiYRts-6l9xcxG5Gm-2tyM1lZ3D2C3Hxqow/exec';
        ...
        <div className="lg:col-span-2 my-4">
          ...
          <div className="text-sm mt-4 space-y-2">
            <p className="flex items-center gap-2">
              <span className="font-medium">Phone:</span> +267 72444713 / +267 74559884
            </p>
            <p className="flex items-center gap-2">
              <span className="font-medium">Email:</span>
              <a href="mailto:skillforge24@gmail.com" className="text-[#cc9900] hover:underline">
